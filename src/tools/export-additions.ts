...
export function registerAdditionalExportTools(server: McpServer): void {
  ...
  // NOTE: export_image and export_video are now browser-delegated.
  // See browser-export.ts for the implementations that use the app's
  // built-in Canvas API rendering via WebSocket.
}
